<template>
  <div class="home">
    <el-container>
      <el-header class="header-box" height="56px">
        ...
        <div class="p-r">
          <div class="user-box p-l">
            <el-avatar class="p-l" icon="el-icon-user-solid" :size="26"></el-avatar>
            <div class="p-l">
              <p>{{ userInfo.userName }}</p>
              <p>{{ userInfo.userRole }}</p>
            </div>
          </div>
          <el-link class="p-l" @click="handleLogout">
            退出
...
<style lang="scss" scoped>
  .home {
    .header-box {
      ...
      background-color: rgb(36, 118, 194);
      ...
      .login-title {
        ...
        .logo {
          ...
          background: url(../../assets/img/logo_balck.png) no-repeat 0px 0px;
